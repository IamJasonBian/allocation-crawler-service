    ...
    "/jobs": {
      get: {
        ...
        parameters: [
          ...
          { name: "user", in: "query", schema: { type: "string" }, description: "Filter runs by user ID (requires runs_for param)" },
        ],
                ...
                oneOf: [
                  ...
                  },
                  {
                    ...
                    properties: {
                      ...
                      job_id: { type: "string" },
                      board: { type: "string" },
                      user_id: { type: "string", description: "User submitting this application" },
    ...
    schemas: {
      ...
      Run: {
        ...
        properties: {
          ...
          job_id: { type: "string" },
          board: { type: "string" },
          user_id: { type: "string", description: "User who submitted this run" },
          status: { type: "string", enum: ["pending", "submitted", "success", "failed"] },
